        ...
        <>
            ...
            <div className="row">
                <div className="col-12 col-md-4 text-center">
                    ...
                    {produto.promo != 0 ?
                        <div>
                            De: <span className="corte">{formataValor(produto.valor)}</span><br />
                            Por: <span className="valor">{formataValor(produto.promo)}</span>
                        </div>

                        :
                        <p className="valor">{formataValor(produto.valor)}</p>
                    ...
                    <form name="formComprar" onSubmit={onSubmit}>
                        ...
                        <button type="submit" className="btn btn-danger w-100">Adicionar</button>
                    </form>
